...
# Kubernetesバージョンアップ
以下理由からコンテナ導入効果の最大化には、Kuberneetsの継続的なアップグレードが必要。
- 新機能の追加
...
[Kubernetesのバージョンアップとの付き合い方](https://eng-blog.iij.ad.jp/archives/17944)

[EKS 更新を始める前に確認しておきたい事前知識](https://tech.gunosy.io/entry/eks-update-consideration)
